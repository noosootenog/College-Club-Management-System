...
-- Normalization from unnormalized → 1NF → 2NF → 3NF
-- Final schema: 3NF with Student, Club, Membership tables
-- =============================================

-- 1. Create the database
DROP DATABASE IF EXISTS CollegeClubDB;   -- Optional: clean start (remove if you don't want to drop)
CREATE DATABASE CollegeClubDB;
USE CollegeClubDB;
